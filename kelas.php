                                            ...
                                            ?>
                                             <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="?page=ubah-kelas&id=<?php echo $data['id_kelas'] ?>" class="btn btn-warning btn-sm rounded"><i
                                                            data data-feather="edit"></i></a>
                                                    <a href="?page=hapus-kelas&id=<?php echo $data['id_kelas'] ?>" onclick="return confirm('Yakin Hapus?')" class="btn btn-danger btn-sm rounded"><i
