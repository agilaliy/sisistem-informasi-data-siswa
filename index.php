		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item
					<?php
					if ($page == 'kelas' || $page == 'tambah-kelas' || $page == 'ubah-kelas') {
						echo 'active';
					}
					?>
					">
					...
					<li class="sidebar-item
					<?php
					if ($page == 'Siswa' || $page == 'tambah-siswa' || $page == 'ubah-siswa') {
						echo 'active';
					}
					?>
					">
						...
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
								...
								<img src="foto/<?php echo $_SESSION['user']['foto'] ?>" class="avatar img-fluid rounded me-1"
									alt="<?php echo $_SESSION['user']['nama'] ?>" /> <span class="text-dark"><?php echo $_SESSION['user']['nama'] ?></span>
							</a>
