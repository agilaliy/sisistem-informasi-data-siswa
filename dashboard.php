									...
									<div class="col-sm-3">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3">
                                                    <?php
                                                    $query = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM siswa WHERE jns_kelamin='Laki-Laki'");
									...
									<div class="col-sm-3">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3">
                                                <?php
                                                    $query = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM siswa WHERE jns_kelamin='Perempuan'");
                                                    $data = mysqli_fetch_array($query);
                                                    echo $data['total'];
                                                    ?>
                                                </h1>
